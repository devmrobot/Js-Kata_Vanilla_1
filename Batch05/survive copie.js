...
const jennyIsSurvive = (bullets, dragon) => {
 if (bullets >= dragon * 2) {
  return "yeaaaah";
 }
};
...
// text method
jennyIsSurvive(10, 5); // true
jennyIsSurvive(7, 4); // false
jennyIsSurvive(4, 5); // false
jennyIsSurvive(100, 40); // true
jennyIsSurvive(1500, 751); // false
jennyIsSurvive(0, 1); // false
